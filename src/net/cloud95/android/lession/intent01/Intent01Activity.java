package net.cloud95.android.lession.intent01;
...
public class Intent01Activity extends Activity {
    ...
    public void clickOk(View view) {
    	...
    	try{
    		...
    		Toast.makeText(this, "Age must be number", Toast.LENGTH_LONG).show();
    		return;
    	}
        // 建立啟動SecondActivity元件的Intent物件
        Intent intent = new Intent(this,SecondActivity.class);//以真正姓名啟動
        // 建立Bundle物件
